...
!(function (t, e) {
  ...
  var h = {},
    ...
    J = function () {
      return (
        Q(document.body, b.shown) &&
        !Q(document.body, b['toast-shown']) &&
        !Q(document.body, b['no-backdrop'])
      );
    },
    X = function () {
      var t = I();
    ...
    et = function (t, e) {
      ...
      switch (e) {
        ...
        case 'radio':
          return (
            t.querySelector(
              '.'.concat(b.popup, ' > .').concat(b.radio, ' input:checked'),
            ) ||
            t.querySelector(
              '.'.concat(b.popup, ' > .').concat(b.radio, ' input:first-child'),
            )
          );
        case 'range':
          return t.querySelector(
    ...
    n &&
      (!(function (t, e) {
        'string' == typeof e
          ...
          : e ||
            it([document.documentElement, document.body], b['no-backdrop']);
      })(n, e.backdrop),
      (function (t, e) {
        if (!e) return;
        e in b
  ...
  var Vt = function (t, e) {
    ...
    zt = function (t, e) {
      ...
      (t.className = ''.concat(b.popup, ' ').concat(pt(t) ? n.popup : '')),
        e.toast
          ? (it([document.documentElement, document.body], b['toast-shown']),
            it(t, b.toast))
          : it(t, b.modal),
        tt(t, e, 'popup'),
            ...
            o && 0 !== o.length && void 0 !== i
              ? (ut(n),
                ...
                o.forEach(function (t, r) {
                  ...
                  if (
                    (n.appendChild(a),
                    r === i && it(a, b['active-progress-step']),
                    r !== o.length - 1)
                  ) {
                    var c = Wt(e);
                    n.appendChild(c);
  ...
  function Ue(t, e) {
    ...
    if (n && t)
      if ('radio' === t.type)
        for (
          var o = n.querySelectorAll('[name="'.concat(b.radio, '"]')), i = 0;
          i < o.length;
          i++
        )
          o[i].disabled = e;
    ...
    Un = function (t, e, n) {
      it(t, n.showClass.backdrop),
        ...
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          it([document.documentElement, document.body], b['height-auto']);
    },
    zn = {
      email: function (t, e) {
